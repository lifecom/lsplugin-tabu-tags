...
class PluginTabutags extends Plugin
{
    ...
    protected $aInherits = array(/*
        ...
        'entity' => array(
            'ModuleValidate_EntityValidatorTags' => '_ModuleValidate_EntityValidatorTags'
        ),
        /*
        'action' => array(
    ...
    public function Activate()
    {
         ...
         */
        /*
        if (!$this->Property_CreateTargetType('tabutags_some', array('entity' => 'PluginTabutags_ModuleMain_EntitySome', 'name' => 'Нечто'), true)) {
            return false;
        }
        */
         ...
         */
        /*
        if (!$this->Category_CreateTargetType('tabutags_some', 'Нечто', array(), true)) {
            return false;
        }
        */
    ...
    public function Deactivate()
    {
         ...
         */
        //$this->Property_RemoveTargetType('tabutags_some', ModuleProperty::TARGET_STATE_NOT_ACTIVE);
        /**
         * Отключаем категории
         */
        //$this->Category_RemoveTargetType('tabutags_some', ModuleCategory::TARGET_STATE_NOT_ACTIVE);
    ...
    public function Remove()
    {
         ...
         */
        //$this->Property_RemoveTargetType('tabutags_some', ModuleProperty::TARGET_STATE_REMOVE);
        /**
         * Удаляем тип категорий
         */
        //$this->Category_RemoveTargetType('tabutags_some', ModuleCategory::TARGET_STATE_REMOVE);
